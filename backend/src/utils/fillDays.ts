// Định nghĩa giao diện cấu trúc dữ liệu DayData chứa thông tin ngày và số đếm thống kê
export interface DayData {
  // Trường ngày có thể là chuỗi hoặc đối tượng Date (tùy chọn)
  date?: string | Date;
  // Số lượng thống kê được trong ngày đó
  count: number;
}

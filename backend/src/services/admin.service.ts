...
export const adminService = {
  ...
  async getDashboardStats() {
    ...
    return {
      ...
      postsPerDay: fillDays(formattedPostsPerDay as any), // Biểu đồ bài đăng 7 ngày qua đã bù đắp ngày trống
      usersPerDay: fillDays(formattedUsersPerDay as any), // Biểu đồ đăng ký mới 7 ngày qua đã bù đắp ngày trống

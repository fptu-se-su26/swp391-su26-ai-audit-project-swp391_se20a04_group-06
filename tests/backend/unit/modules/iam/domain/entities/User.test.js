...
const User_1 = require("../../../../../../../backend/src/modules/iam/domain/entities/User");
// Import lớp sự kiện miền UserPremiumUpgradedEvent để kiểm tra tính đúng đắn khi phát sự kiện
const UserPremiumUpgradedEvent_1 = require("../../../../../../../backend/src/modules/iam/domain/events/UserPremiumUpgradedEvent");
...
describe("IAM Module - User Aggregate Root", () => {
    ...
    it("nên kiểm tra trạng thái hoạt động chính xác", () => {
        ...
        const userActive = new User_1.User({
            // Gán tên người dùng
            name: "Ngư dân A",
        ...
        const userInactive = new User_1.User({
            // Gán tên người dùng
            name: "Ngư dân B",
            // Gán email người dùng
    ...
    it("nên nâng cấp Premium và kích hoạt sự kiện UserPremiumUpgradedEvent", () => {
        ...
        expect(user.domainEvents[0]).toBeInstanceOf(UserPremiumUpgradedEvent_1.UserPremiumUpgradedEvent);

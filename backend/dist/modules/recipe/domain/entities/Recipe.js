...
class Recipe extends AggregateRoot_1.AggregateRoot {
    ...
    validate() {
        ...
        if (!this.props.title || this.props.title.trim() === "") {
            ...
            throw new DomainException_1.ValidationError("Tiêu đề không được trống.");
        }
    }
    ...
    update(data) {
        ...
        if (data.ingredients !== undefined)
            this.props.ingredients = data.ingredients;
        // Nếu có danh sách các bước hướng dẫn mới, thực hiện cập nhật
        if (data.instructions !== undefined)
            this.props.instructions = data.instructions;
        ...
        if (data.cookingTime !== undefined)
            this.props.cookingTime = data.cookingTime;
        // Nếu có số lượng khẩu phần ăn mới, thực hiện cập nhật
        if (data.servings !== undefined)
            this.props.servings = data.servings;

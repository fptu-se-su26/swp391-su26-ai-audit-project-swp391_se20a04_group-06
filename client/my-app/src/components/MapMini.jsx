      ...
      return (
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "#7f1d1d", margin: "0 0 14px 0" }}>
            Trình duyệt hoặc thư viện bản đồ không khởi chạy được. Bạn vẫn có thể xem trực tiếp vị trí trên Google Maps.
          </p>
          <a
...
function MapMiniContent({ lat, lng, catchLat, catchLng, productName }) {
  ...
  const bounds = React.useMemo(() => {
    ...
    const list = [[sellerLat, sellerLng], [parseFloat(catchLat), parseFloat(catchLng)]];
    ...
    >
      ...
      >
        <span style={{ fontWeight: 700, fontSize: 14, color: C.dark }}>
          {hasCatchLoc ? "🗺️ Hành trình đánh bắt & giao hàng" : "📍 Vị trí người bán"}
        </span>
        {geoState === "loading" && (
          ...
          >
            ...
            {userCoords && (
              <Marker position={[userCoords.lat, userCoords.lng]} icon={userIcon}>
                <Popup>
                  <div style={{ fontWeight: 600, fontSize: 12 }}>🧍 Vị trí hiện tại của bạn</div>
                </Popup>
              </Marker>
            )}
            ...
            <Marker position={[sellerLat, sellerLng]} icon={portIcon}>
              <Popup>
                <div style={{ fontSize: 12 }}>
                  ⚓ <strong>Cảng neo đậu/Kho bán:</strong><br />
            ...
            {/* Ngư trường kéo lưới */}
            <Marker position={[parseFloat(catchLat), parseFloat(catchLng)]} icon={boatIcon}>
              <Popup>
                <div style={{ fontSize: 12 }}>
                  🚢 <strong>Điểm thả lưới đánh bắt:</strong><br />
                  Mẻ <strong>{productName || "hải sản"}</strong> được đánh bắt tại đây ngoài khơi xa!
                </div>
              </Popup>
            </Marker>
            ...
            <Polyline 
              positions={[[parseFloat(catchLat), parseFloat(catchLng)], [sellerLat, sellerLng]]} 

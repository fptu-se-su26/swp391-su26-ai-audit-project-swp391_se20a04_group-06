...
// Định nghĩa giao diện (interface) CommentProps chứa các thuộc tính cốt lõi của một bình luận
export interface CommentProps {
  // Mã định danh duy nhất của bình luận (tùy chọn)
  id?: string;
  // ID người dùng đã tạo bình luận này
  userId: string;
  // Tên hiển thị của người bình luận
  userName: string;
  // Đường dẫn ảnh đại diện của người bình luận (có thể rỗng)
...
// Định nghĩa giao diện (interface) PostProps chứa các thuộc tính cốt lõi của một bài viết
export interface PostProps {
  // ID của người dùng đã viết bài đăng này
  userId: string;
  // Tên hiển thị của người viết bài
  userName: string;
  // Ảnh đại diện của người viết bài (có thể rỗng)
  userAvatar: string | null;
  // Tiêu đề của bài viết
  title: string;
  // Nội dung chi tiết của bài viết
  content: string;
  // Mảng chứa danh sách link hình ảnh đính kèm bài đăng
  images: string[];
  // Mảng chứa các thẻ từ khóa (tags) phân loại nội dung bài viết
  tags: string[];
  // Mảng chứa danh sách ID những người dùng đã thích bài viết này
  likes: string[];
  // Mảng chứa danh sách các bình luận dưới bài viết này
  comments: CommentProps[];
  // Số lượt xem bài viết
  viewCount: number;
  // Thời điểm bài viết được tạo ra
  createdAt?: Date;
}

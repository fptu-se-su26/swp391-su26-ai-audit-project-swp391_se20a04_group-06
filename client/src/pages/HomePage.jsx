...
export function HomePage() {
  ...
  // ✅ FIX Bug 1: logLikes là derived state — dùng useMemo thay vì useState + useEffect
  // Không gọi API, không trigger cascading renders
  ...
  // ✅ FIX Bug 1: deps array là [] — chỉ fetch 1 lần khi mount, không phụ thuộc user
  // Trước: [user] → fetch 2 lần (user=null → user=object)
  useEffect(() => {
    (async () => {
      try {
  ...
  // ✅ FIX Bug 1: Optimistic update qua setBoatLogs → useMemo tự recompute logLikes
  // Không còn setLogLikes riêng

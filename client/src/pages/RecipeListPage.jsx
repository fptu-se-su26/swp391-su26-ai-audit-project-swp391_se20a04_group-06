...
export function RecipeListPage() {
  ...
  return (
    /* Lớp bao bọc ngoài cùng có padding và maxWidth đồng bộ với trang sản phẩm */
    <div
      className="page-wrap-lg fade-up"
      style={{ padding: "0 256px", margin: "0 auto", maxWidth: "1200px" }}
    >
      {/* Container nội dung trên nền màu xanh của trang sản phẩm */}
      <div
      ...
      >
        ...
        >
          <div>
            <h1
              style={{
                fontSize: "2rem",
                fontWeight: "900",
                color: "black", // Đổi sang màu trắng để nổi bật trên nền xanh
                marginBottom: "12px",
              }}
            >
            ...
            <p
              style={{
                color: "black", // Đổi sang màu trắng mờ để dễ nhìn trên nền xanh
                maxWidth: "600px",
                fontSize: "14.5px",
                lineHeight: "1.6",
              }}
          ...
          {isVerifiedUser && (
            <button
              ...
              style={{
                background: "#ECD223", // Màu vàng giống trang sản phẩm
                color: "#166f52", // Chữ màu xanh giống trang sản phẩm
                border: "none",
                borderRadius: "99px",
                padding: "12px 24px",
                fontWeight: "700",
        ...
        {/* Khối Bộ lọc tìm kiếm (Dạng thẻ trắng) */}
        <div
          style={{
        ...
        {loading ? (
          <div
            style={{
              textAlign: "center",
              padding: "80px 0",
              color: "rgba(255, 255, 255, 0.8)", // Màu trắng mờ cho dễ nhìn trên nền xanh
            }}
          >
            Đang tải công thức...
          </div>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontSize: "14px",
                    fontWeight: "600",
                    color: "#fff", // Đổi màu trắng để nhìn rõ hơn trên nền xanh
                  }}
                >
                  Trang {page} / {pages}
                </span>

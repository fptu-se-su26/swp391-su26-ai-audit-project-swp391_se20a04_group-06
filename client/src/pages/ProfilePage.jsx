...
export function ProfilePage() {
  ...
  // ✅ FIX 1: Xoá useEffect sync setState — cập nhật form fields trực tiếp trong handler thay vì
  // gọi setName/setEmail/setAvatarPreview đồng bộ trong effect body (cascading renders).
    ...
    if (initialUser && !initialUser.isPremium && finalUserId) {
      const interval = setInterval(async () => {
        try {
          ...
          /* silent */
          // ✅ FIX 2 & 3: bỏ (e) unused var + empty block
        }
      }, 3000);
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      // ✅ FIX 1: Cập nhật form fields trực tiếp thay vì dùng useEffect sync
      setName(res.name || "");
      setEmail(res.email || "");

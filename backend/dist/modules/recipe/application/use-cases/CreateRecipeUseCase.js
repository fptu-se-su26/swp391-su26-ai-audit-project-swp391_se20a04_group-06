...
exports.CreateRecipeUseCase = void 0;
...
class CreateRecipeUseCase {
    ...
    async execute(userId, role, dto) {
        ...
        if (role !== "Admin" && !user.isVerified) {
            ...
            throw new DomainException_1.UnauthorizedError("Chỉ Admin hoặc ngư dân đã xác minh mới được viết công thức nấu ăn");
        }

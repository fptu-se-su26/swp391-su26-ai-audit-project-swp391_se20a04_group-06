...
const fillDays_1 = require("../../../../backend/src/utils/fillDays");
...
describe("Unit Test: Tiện ích bù ngày thống kê (fillDays.ts)", () => {
    ...
    it("Nên trả về đủ 7 phần tử đại diện cho 7 ngày gần nhất khi mảng đầu vào rỗng", () => {
        ...
        const result = (0, fillDays_1.fillDays)(emptyInput);
    ...
    it("Nên điền đúng số lượng bài đăng vào đúng ngày tương ứng trong danh sách", () => {
        ...
        const result = (0, fillDays_1.fillDays)(mockData);
        ...
        expect(todayResult.label).toBe(`${today.getDate()}/${today.getMonth() + 1}`);
        ...
        expect(yesterdayResult.label).toBe(`${yesterday.getDate()}/${yesterday.getMonth() + 1}`);
    });
});

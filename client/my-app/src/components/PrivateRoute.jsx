 ...
 * PrivateRoute.jsx
 *
 * PATTERN: Higher-Order Component (HOC) / Wrapper Pattern
 *
 * Vấn đề cũ trong App.jsx:
 *   <Route
 *     path="/dashboard"
 *     element={
 *       user ? (
 ...
 *   />
 *
 *   → Inline ternary lặp lại 5 lần cho 5 protected routes
 *   → Mỗi lần lại truyền user={user} tay
 *   → Logic bảo vệ route bị scattered khắp nơi
 *
 * Giải pháp:
 *   - PrivateRoute bọc mọi route cần auth
 *   - Tự lấy user từ AuthContext, không cần prop
 *   - AdminRoute mở rộng thêm check role
 */

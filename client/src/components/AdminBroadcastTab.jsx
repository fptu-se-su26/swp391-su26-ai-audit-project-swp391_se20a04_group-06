    ...
    <div className="row g-4">
      ...
      <div className="col-12 col-lg-6">
        <div
          style={{
            ...
            borderRadius: 16, // Bo góc viền 16px
            border: `1px solid ${C.border}`, // Viền ngoài màu nhẹ mặc định
            padding: 24, // Đệm lề trong 24px rộng rãi
        ...
        >
          ...
          <div
            style={{
              ...
              marginBottom: 20, // Khoảng cách cách khối phía dưới 20px
            }}
          >
          ...
          <div
            style={{
              ...
              gap: 8, // Khoảng cách giữa các nút là 8px
              flexWrap: "wrap", // Cho phép tự xuống dòng nếu màn hình hẹp
              marginBottom: 20, // Khoảng cách cách ô text bên dưới 20px
            }}
          >
            ...
            {TARGETS.map((t) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 20, // Bo tròn viền dạng hình viên thuốc
                  ...
                  fontFamily: "inherit",
                  transition: "all 0.15s ease", // Hiệu ứng chuyển tiếp mượt mà
                }}
              >
                {t.label}
              </button>
          ...
          {content.trim() && (
            <div
              style={{
                background: "rgba(11,79,108,0.04)", // Nền xanh ocean nhạt 4%
                border: `1px solid ${C.border}`, // Đường viền mỏng
                borderLeft: `4px solid ${C.ocean}`, // Viền gạch đứng nổi bật ở mép trái
                borderRadius: 10, // Bo góc nhẹ 10px
                padding: "12px 14px", // Đệm lề trong
                marginBottom: 16, // Khoảng cách cách nút gửi bên dưới
              }}
            >
              {/* Nhãn xem trước */}
              <div
              ...
              {/* Nội dung dòng xem trước */}
              <div
                style={{ display: "flex", gap: 10, alignItems: "flex-start" }}
              >
                {/* Icon loa phát thanh 📢 hình tròn */}
                <div
                  style={{
                    width: 32,
                    height: 32,
                ...
                <div>
                  ...
                  {/* Nhãn mô tả thông tin thời gian giả lập và đối tượng nhận tin */}
          ...
          <button
            ...
            style={{
              ...
              padding: "12px 0", // Đệm dọc nút bấm
              ...
              fontFamily: "inherit",
              transition: "background 0.2s", // Hiệu ứng đổi màu nền mượt mà
            }}
          >
      ...
      <div className="col-12 col-lg-6">
        <div
          style={{
            background: C.white, // Nền trắng sáng
            borderRadius: 16, // Bo tròn viền 16px
            border: `1px solid ${C.border}`, // Viền ngoài màu nhẹ mặc định
            padding: 24, // Đệm lề trong 24px
          ...
          {histLoading ? (
            ...
            <div
              style={{
                ...
                gap: 10, // Khoảng cách giữa các dòng thông báo là 10px
                maxHeight: 420, // Chiều cao tối đa khu vực scroll là 420px
            ...
            >
              ...
              {history.map((h, i) => (
                <div
                  ...
                  style={{
                    padding: "12px 14px", // Đệm lề dòng thông báo

...
/**
 * FollowManagement
 * Dùng trong trang quản lý (profile / dashboard) của user.
 * Hiển thị:
 *  - Tab "Đang theo dõi": danh sách ngư dân user đang follow, có nút Bỏ theo dõi
 *  - Tab "Người theo dõi": danh sách user đang follow mình
 *
 * Props:
 *  - user  — object từ useAuth()  (cần user.userId)
 */

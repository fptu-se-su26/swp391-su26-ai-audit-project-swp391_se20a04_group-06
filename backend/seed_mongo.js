...
const MONGO_URI = "mongodb://127.0.0.1:27017/seafood_db";
...
async function main() {
  try {
    ...
    console.log("Cleared existing users, products, messages, subscriptions, recipes, and posts");

    const passwordHash = "$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhy/"; // password123

    // Insert Users
    const usersData = [
      { name: 'Admin', email: 'admin@haisan.vn', passwordHash, role: 'Admin', isActive: true, isVerified: true },
      { name: 'Nguyễn Văn Bình', email: 'binh@haisan.vn', passwordHash, role: 'User', isActive: true, isVerified: true },
      { name: 'Trần Thị Lan', email: 'lan@haisan.vn', passwordHash, role: 'User', isActive: true, isVerified: true },
      { name: 'Lê Minh Tuấn', email: 'tuan@haisan.vn', passwordHash, role: 'User', isActive: true, isVerified: true },
      { name: 'Phạm Thu Hương', email: 'huong@haisan.vn', passwordHash, role: 'User', isActive: true, isVerified: true },
      { name: 'Võ Thị Mai', email: 'mai@haisan.vn', passwordHash, role: 'User', isActive: true, isVerified: true },
      { name: 'Nguyễn Văn An', email: 'an@haisan.vn', passwordHash, role: 'User', isActive: true, isVerified: true },
      { name: 'Trần Văn Dũng', email: 'dung@haisan.vn', passwordHash, role: 'User', isActive: true, isVerified: true }
    ];

    const usersResult = await mongoose.connection.db.collection('users').insertMany(usersData);
    ...
    const productsData = [
      {
        ...
        description: 'Cá thu vừa cập bến Hải Phòng, còn tươi nguyên. Thịt chắc, ngọt nước. Hỗ trợ cắt lát cho gia đình.',
        price: 180000,
        salesType: 'Retail',
        totalWeight: 50,
        remainingWeight: 38,
      ...
      },
      {
        ...
        description: 'Tôm hùm bông sống, cam kết bơi lội khỏe mạnh. Vận chuyển toàn quốc bằng bình oxy.',
        price: 850000,
        salesType: 'Retail',
        totalWeight: 20,
        remainingWeight: 12,
        ...
        images: ['https://images.unsplash.com/photo-1559737607-35789393fad9?auto=format&fit=crop&w=600&q=80'],
        viewCount: 42,
        bumpedAt: new Date(),
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description: 'Cua biển gạch son Cà Mau chính gốc, dây trói siêu nhỏ. Cua nhiều gạch ngọt béo.',
        price: 320000,
        salesType: 'Wholesale',
        totalWeight: 30,
        remainingWeight: 30,
        ...
        images: ['https://images.unsplash.com/photo-1553618551-fba689030290?auto=format&fit=crop&w=600&q=80'],
        viewCount: 28,
        bumpedAt: new Date(),
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description: 'Mực ống nháy Côn Đảo, cấp đông nhanh trên tàu. Da mực còn lóng lánh nhấp nháy.',
        price: 150000,
        salesType: 'Retail',
        totalWeight: 40,
        remainingWeight: 40,
        ...
        images: ['https://images.unsplash.com/photo-1616781296184-25e2e8e3919e?auto=format&fit=crop&w=600&q=80'],
        viewCount: 9,
        bumpedAt: new Date(),
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description: 'Mực một nắng Phú Quốc phơi từ mực ống tươi roi rói. Thịt mềm ngọt, không dai cứng.',
        price: 680000,
        salesType: 'Retail',
        totalWeight: 100,
        remainingWeight: 75,
        ...
        images: ['https://images.unsplash.com/photo-1599084993091-1cb5c0721cc6?auto=format&fit=crop&w=600&q=80'],
        viewCount: 50,
        bumpedAt: new Date(),
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description: 'Cá thiều khô tẩm gia vị truyền thống phơi 2 nắng. Miếng cá dày thịt thơm ngọt.',
        price: 280000,
        salesType: 'Retail',
        totalWeight: 50,
        remainingWeight: 50,
      ...
      },
      {
        ...
        description: 'Tôm đất khô làm thủ công từ tôm đất tự nhiên sông Đốc Cà Mau. Màu đỏ gạch tự nhiên.',
        price: 420000,
        salesType: 'Retail',
        totalWeight: 30,
        remainingWeight: 20,
      ...
      },
      {
        ...
        description: 'Cá cơm phơi khô giòn, thích hợp làm món rim tỏi ớt hoặc kho tiêu ngon cơm.',
        price: 180000,
        salesType: 'Retail',
        totalWeight: 20,
        remainingWeight: 18,
        ...
        images: ['https://images.unsplash.com/photo-1546964124-0cce460f38ef?auto=format&fit=crop&w=600&q=80'],
        viewCount: 7,
        bumpedAt: new Date(),
        createdAt: new Date(),
        updatedAt: new Date()
    ...
    // Insert Messages
    const firstProduct = await mongoose.connection.db.collection('products').findOne({ name: 'Cá Thu Tươi Đồ Sơn' });
    const messagesData = [
      {
    ...
    const subscriptionsResult = await mongoose.connection.db.collection('subscriptions').insertMany(subscriptionsData);
    ...
    const recipesData = [
      {
        ...
        description: 'Món ăn dân dã dễ chế biến giúp giữ nguyên vị ngọt đậm đà tự nhiên của mực ống tươi nháy.',
        ingredients: [
          '500g Mực ống tươi',
          '300ml Giấm gạo',
          '1 củ Hành tây',
      ...
      },
      {
        ...
        description: 'Bí quyết hấp cua biển ngọt thịt, thơm ngậy không tanh từ đầu bếp HảiSản.vn.',
        ingredients: [
        ...
        imageUrl: 'https://images.unsplash.com/photo-1553618551-fba689030290?auto=format&fit=crop&w=600&q=80',
    ...
    const recipesResult = await mongoose.connection.db.collection('recipes').insertMany(recipesData);
    ...
    const postsData = [
      {
        ...
        content: 'Vừa nhận được 2kg cá thu cắt lát của bác Bình chuyển lên sáng nay. Cá thịt dai ngọt cực kỳ, chiên sốt cà chua đưa cơm dã man. Cảm ơn bác Bình nhé!',
        images: ['https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&w=600&q=80'],
        likes: [binhId, tuanId],
        comments: [
          {
      ...
      },
      {
        ...
        content: 'Mới nhận hộp định kỳ tuần này từ HảiSản.vn. Bên trong có 1 con cá song biển đỏ tươi rói khoảng 1.2kg, thêm nửa cân tôm rằn và nghêu lụa sạch cát. Hải sản bọc đá xay cứng ngắc mát lạnh cực kỳ. Quá tiện cho nhà bận rộn!',
        images: ['https://images.unsplash.com/photo-1559737607-35789393fad9?auto=format&fit=crop&w=600&q=80'],
        likes: [lanId],
        comments: [
          {
    ...
    const postsResult = await mongoose.connection.db.collection('posts').insertMany(postsData);

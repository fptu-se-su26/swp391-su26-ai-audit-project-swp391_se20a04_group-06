...
export async function getTargetedAds(req: Request, res: Response): Promise<void> {
  try {
    const targetRole = String(req.query.targetRole || "buyer");
    const ads = targetRole === "seller" ? SELLER_ADS : BUYER_ADS;

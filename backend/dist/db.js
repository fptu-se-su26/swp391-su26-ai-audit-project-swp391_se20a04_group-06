...
const seedDatabase = async () => {
    try {
        ...
        logger_1.logger.info("🌱 Database is empty. Seeding fallback database data...");
        ...
        const s1 = await User_1.User.create({
        ...
        const s2 = await User_1.User.create({
        ...
        const s3 = await User_1.User.create({
        ...
        const s4 = await User_1.User.create({
        ...
        const b1 = await User_1.User.create({
            name: "Buyer Minh",
        ...
        const b2 = await User_1.User.create({
            name: "Bếp Mộc",
        ...
        logger_1.logger.error(`❌ Database seeding failed: ${err.message}`);
    }
};
